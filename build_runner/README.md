...
- Read [Writing Builders](https://github.com/dart-lang/build/blob/master/docs/writing_builders.md) to understand builder types, output strategies, and how builders integrate with Dart libraries.
