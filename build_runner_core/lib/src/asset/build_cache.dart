...
class BuildCacheReader implements AssetReader {
  ...
  Future<bool> canRead(AssetId id) {
    if (debug.kLog)
      debug.justLog('canRead $id [BuildCacheReader over $_delegate]');
    return _delegate.canRead(_cacheLocation(id, _assetGraph, _rootPackage));
  }
...
class _PathProvidingBuildCacheReader extends BuildCacheReader
  ...
  _PathProvidingBuildCacheReader._(
    PathProvidingAssetReader super.delegate,
    super.assetGraph,
    super.rootPackage,
  ) : super._();
